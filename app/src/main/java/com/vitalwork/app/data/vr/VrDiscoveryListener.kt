 ...
 *
 * Lifecycle is owned by [com.vitalwork.app.service.SessionRecordingService]: started for the
...
class VrDiscoveryListener @Inject constructor(
    ...
    private companion object {
        ...
        const val SERVICE_NAME = "vitalwork-vr"
        const val REPLY_SERVICE_NAME = "vitalwork-vr-tablet"
        const val HTTP_PORT = 8080
        const val PROTOCOL_VERSION = 1
        const val MULTICAST_LOCK_TAG = "VitalWork:VrDiscovery"
